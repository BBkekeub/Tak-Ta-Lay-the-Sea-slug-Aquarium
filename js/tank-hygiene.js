...
(()=>{
 ...
 button.onclick=()=>{if(tankBrush){stop();return;}tankBrush=true;foodChoice=null;foodHover=null;if(tankBuildMode)document.getElementById('ovBuild').click();tankBrush=true;cancelHold();pendSlug=null;update();};
