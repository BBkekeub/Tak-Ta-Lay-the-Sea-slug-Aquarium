...
(function(){
 ...
 const ORIGINAL_QUESTS=[
  {t:'ให้อาหารทากทะเล', h:'คลิกเข้าตู้ แล้วลองวางอาหารให้ทากสักตัว', cond:b=>S().fed>b.fed, reward:{coin:300, rep:0, txt:'ปลดล็อกอาหารที่ดีขึ้น'}, btn:'#mView'},
  ...
  {t:'ทำประตูเข้าร้าน', h:'โหมดก่อสร้าง → ปุ่ม 🚪 ประตู เลือกตำแหน่งบนกำแพง วางประตูให้ลูกค้าเดินเข้าได้', cond:b=>!!G.door, reward:{coin:100, rep:0, txt:'ลูกค้าเดินเข้าร้านได้แล้ว'}, btn:['button[onclick^="placeEntrance"]','#mBuild']},
  ...
  {t:'วางตู้เพาะพันธุ์', h:'เปิดที่พักพิง เลือกตู้เพาะพันธุ์ฟรีที่ได้รับ แล้ววางในร้าน', cond:b=>breederExists(), reward:{coin:200, rep:2, txt:'ปลดล็อกการเพาะพันธุ์'}, btn:'#mBuild'},
  {t:'ผสมพันธุ์ทากคู่แรก', h:'เข้าตู้เพาะ เลือกทากว่าง 2 ตัว แล้วเริ่มผสมพันธุ์', cond:b=>S().bred>b.bred, reward:{coin:150, rep:1, txt:'รอลูกทากตัวแรกได้เลย'}, btn:'#mView'},
  {t:'วางเคาน์เตอร์ขายทาก', h:'โหมดก่อสร้าง → วางเคาน์เตอร์ (ฟรี) ไว้ให้ลูกค้ามาเสนอราคาซื้อทาก', cond:b=>(G.objs||[]).some(o=>o&&o.type==='deco'&&o._key==='counter'), reward:{coin:100, rep:1, txt:'พร้อมขายทากแล้ว'}, btn:['button[onclick^="placeTradeCounter"]','#mBuild']},
