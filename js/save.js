...
function loadGame(){
  ...
  try{
    ...
    G.sumo=(d.sumo&&typeof d.sumo==='object')?d.sumo:null;   /* ดันวง — ตรวจรูปร่างซ้ำตอนโหลด slug-sumo.js */
    /* เซฟเก่าไม่มีค่านี้ = เริ่มนับจากตอนนี้ ไม่แจกค่าเข้าย้อนหลังให้ฟรี ๆ ในครั้งแรกที่อัปเดตเกม
       ค่าที่อยู่ในอนาคต (นาฬิกาเครื่องถูกปรับ) ก็ตัดกลับมาเป็นตอนนี้ กันแจกเพดานรัว ๆ */
    G.seenAt=Math.min(_NUM(d.seenAt,Date.now()),Date.now());
