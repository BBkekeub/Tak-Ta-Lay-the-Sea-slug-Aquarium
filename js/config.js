...
const START_BW   = 10;     // พื้นที่เริ่มต้น กว้าง (ช่องใหญ่) = 5 เมตร (เดิม 8)
const START_BH   = 10;     // พื้นที่เริ่มต้น ลึก (ช่องใหญ่) = 5 เมตร (เดิม 6)
...
const BUY_CHANCE = 0.10;          // อัตราพื้นปลายเกม (เดิม 0.04) · ใช้กับสูตรครอบครัวเท่านั้นแล้ว (earlyFactor)
const BUY_FAMILY_SCALE = 0.4;     // เดิม 1
const SOLO_BUY_CHANCE = 0.20;     // ลูกค้าเดี่ยว/คู่ (ไม่มีเด็ก): โอกาสขอซื้อ "คงที่ 20% ตลอด" ไม่แรมป์ · ครอบครัวยังใช้ familyPurchaseChance() ตามเดิม
