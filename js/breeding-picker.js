...
/* ---- ชี้การ์ด (เมาส์/คีย์บอร์ด) หรือกดค้าง (จอสัมผัส) = แผงข้อมูลทาก ----
   ย้ายไปเป็นของกลางที่ slug-hover.js แล้ว ทุกหน้าเลือกทากใช้ตัวเดียวกัน หน้าตา/พฤติกรรมจึงเหมือนกันหมด
   (การ์ดแต่ละใบถูกติดป้ายด้วย SlugHover.mark() ใน renderBreedingPicker) */
SlugHover.attach(breedingPicker);
