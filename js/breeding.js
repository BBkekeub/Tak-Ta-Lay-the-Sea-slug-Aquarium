...
function walkBreedingZone(s,dt){
 ...
 /* ท่าที่คิดจาก s.stt (สะดุ้ง/ตื่น/ยืด/จาม) ใช้ฟังก์ชันเดียวกับลูปตู้ปกติ — ห้ามก๊อปสูตรมาไว้ที่นี่
    ไม่งั้นค่าอย่าง startle ค้างที่ 1 แล้วหงอนหดค้างไม่ชูกลับ (ผู้เล่นเจอ 2026-09-21) */
 if(typeof slugPoseTimers==='function')slugPoseTimers(s,dt);
