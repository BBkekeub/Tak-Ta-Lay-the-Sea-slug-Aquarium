/* BGM playlist: play every track in Asset/BGM, then repeat the playlist. */
const BGM_TRACKS = [
  '../Asset/BGM/Good night.wav',
  '../Asset/BGM/cozy-mornings-all-good-folks-main-version-45131-01-48.mp3',
  '../Asset/BGM/lazy-sunday-hybridas-main-version-38210-01-22.mp3'
];
let _bgmI = 0;
const bgm = new Audio();
bgm.loop = false;
